...
export default function AiWriterCategories() {
  ...
  const {
    ...
    search,
    setSearch,
  } = useGetCategoriesData(currentPage);
      ...
      },
      {
        ...
        accessor: (data: any) => (
          <div>
            <Tippy content="Edit">
              <Link
                href={`/admin/templates/ai-writer-categories/edit/${data.id}`}
              >
                <button type="button">
                  <svg
                    width="24"
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="mb-4 items-center justify-between md:flex">
        <Link
          href={`/admin/templates/ai-writer-categories/create`}
      ...
      <div className="panel h-full">
        <DynamicTable
          data={categories?.data?.list || []}
          loading={isLoading}
          columns={columns}
          totalItems={categories?.data?.meta?.total}
          perPageItems={categories?.data?.meta?.perPage}
          handlePageClick={handlePageClick}
          activePage={categories?.data?.meta?.currentPage}
