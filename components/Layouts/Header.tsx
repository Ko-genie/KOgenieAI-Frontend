            ...
            <div className="flex items-center justify-end space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
              {user?.role === USER_ROLE_ADMIN && (
                <Link href={`/admin/dashboard`}>
                  <button className="btn btn-outline-primary hidden rounded-full lg:block">
                    Admin Panel
                  </button>
                </Link>
              )}
              ...
              <Link href={`/upgrade`}>
                <button
                  type="button"
                  className="btn btn-primary hidden items-center gap-2 rounded-full border-0 bg-gradient-to-r from-primary to-secondary lg:flex"
                >
                ...
                >
                  <ul className="w-[300px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                    ...
                    <li className="border-t border-white-light dark:border-white-light/10">
                      {/* @ts-ignore */}
                      <a
                        className="cursor-pointer !py-3 text-danger"
                        onClick={Logout}
                      >
                        <svg
