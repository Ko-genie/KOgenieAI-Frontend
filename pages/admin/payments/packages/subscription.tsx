...
import { usePackages, useGetPackagesData } from "@/hooks/paymentSettings.hook";
...
const Index = () => {
  ...
  const {
    ...
    setCurrentPage,
    handlePageClick,
  } = useGetPackagesData(PACKAGE_TYPES.SUBSCRIPTION);
  const { handleDeleteDataPackegs } = usePackages();
  ...
  const columns = useMemo(
    () => [
      ...
      { Header: t("Total Words"), accessor: "total_words" },
      { Header: t("Total Images"), accessor: "total_images" },
      { Header: t("Update At"), accessor: "updated_at" },
      {
        Header: t("Actions"),
        accessor: (data: any) => (
          <div>
  ...
  return (
    <div className="m-6 dark:text-white">
      <div className="relative flex h-full min-h-[calc(100vh_-_150px)] gap-5">
        <div
        ...
        <div className="flex-1 overflow-auto">
          <div className="panel h-full flex-1  p-0">
            <div className="flex h-full flex-col">
              <div className="flex w-full flex-col gap-4 p-4 sm:flex-row sm:items-center xl:!hidden">
